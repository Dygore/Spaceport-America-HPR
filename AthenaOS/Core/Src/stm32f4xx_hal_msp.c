...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(Extra_SCL_GPIO_Port, Extra_SCL_Pin);

    HAL_GPIO_DeInit(Extra_SDA_GPIO_Port, Extra_SDA_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, Altus_SCK_Pin|Altus_MISO_Pin|Altus_MOSI_Pin);
